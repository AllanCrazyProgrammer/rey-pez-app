            ...
            crudo.items.forEach(item => {
              ...
              if (item.taras) {
                ...
                if (formatoGuion) {
                  ...
                  if (peso === 19) {
                    peso = 20;
                    console.log(`Cuenta Catarro - Ajustando tara de formato ${item.taras} a ${cantidad}-${peso} para cálculo de venta`);
                  }
              ...
              if (item.sobrante) {
                ...
                if (formatoGuion) {
                  ...
                  if (pesoSobrante === 19) {
                    pesoSobrante = 20;
                    console.log(`Cuenta Catarro - Ajustando sobrante de formato ${item.sobrante} a ${cantidadSobrante}-${pesoSobrante} para cálculo de venta`);
                  }
