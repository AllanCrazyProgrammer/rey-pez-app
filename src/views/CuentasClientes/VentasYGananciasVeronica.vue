<template>
  <div class="ventas-ganancias-veronica">
    <div class="header">
      <button class="back-button" @click="volverAlMenu">Volver</button>
      <h2>Análisis de Ventas y Ganancias - Veronica</h2>
    </div>
...
export default {
  ...
  methods: {
    ...
    procesarDatos(datos) {
      ...
      this.periodos = datosProcesados.map(d => d.periodo);
    ...
    crearGraficas() {
      this.crearGrafica('ventasChart', 'Ventas', this.ventas, '#ff8c00');
